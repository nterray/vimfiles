This is the vimfiles I use for work, mainly for PHP files. Originaly written and shared by ANDREI ZMIEVSKI. 
See http://zmievski.org/2007/02/vim-for-php-programmers-slides-and-resources for
details.

Below is the original README by Andrei:
